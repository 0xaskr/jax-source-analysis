...
Usage:
  python3 -B research/call-to-llo/render_matmul_walkthrough.py \
      --output research/call-to-llo/figures/matmul-lowering-chain.svg [--check]
"""
...
def main():
    ...
    ap.add_argument("--output", type=Path,
                    default=Path("research/call-to-llo/figures/matmul-lowering-chain.svg"))
