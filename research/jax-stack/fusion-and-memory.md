...
```bash
.venv/bin/python -B research/jax-stack/verify_fusion_memory.py --selftest
.venv/bin/python -B research/jax-stack/fusion_memory_probe.py --output artifacts/jax-stack/fusion-memory-replay
```
