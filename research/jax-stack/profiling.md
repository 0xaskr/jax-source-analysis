...
```bash
.venv/bin/python -B research/jax-stack/verify_extensions.py --selftest
.venv/bin/python -B research/jax-stack/profile_events_probe.py --output artifacts/jax-stack/profile-events-replay
.venv/bin/python -B research/jax-stack/compiler_events_probe.py --output artifacts/jax-stack/compiler-events-replay
.venv/bin/python -B research/jax-stack/mosaic_events_probe.py --output artifacts/jax-stack/mosaic-events-replay
```
