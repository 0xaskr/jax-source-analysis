...
结果见 [extension-results.json](extension-results.json) 的 `pallas`；脚本为
[pallas_probe.py](pallas_probe.py)。
...
较大 tile 的生产 Mosaic lowering 见 [profiling.md](profiling.md)；它与本节小形状实验分别记录，
