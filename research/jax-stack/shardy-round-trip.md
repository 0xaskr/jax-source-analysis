...
"$SOURCE_PY" -B research/jax-stack/shardy_probe.py --mode shardy \
...
"$SOURCE_PY" -B research/jax-stack/shardy_probe.py --mode gspmd \
  --output artifacts/jax-stack/shardy-runtime-new/gspmd \
  --jaxlib-build-manifest manifests/build-fingerprints/kickoff-cpu-source-003.json
"$SOURCE_PY" -B research/jax-stack/verify_shardy.py \
