...
def main():
    ...
    write_json(output/"manifest.json",{"capture_id":output.name,"outcome":"pass","evidence_level":"RUN-CPU",
        ...
        "producer":{"argv":[".venv/bin/python","-B","research/jax-stack/mosaic_events_probe.py","--output",str(output.relative_to(ROOT))],"source":str((output/"producer.py").relative_to(ROOT)),**fingerprint(output/"producer.py")},
