...
# research/software-stack/jax-repo/make_diagrams.py actually exists in the pinned checkout
# upstream/jax (and, for tokens qualified with an `xla/` prefix, in
# upstream/xla).
#
# Usage:
#   python3 -B research/software-stack/jax-repo/verify_structure.py
#
