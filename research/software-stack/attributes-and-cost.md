...
```bash
.venv/bin/python -B research/software-stack/verify_attributes.py --selftest
.venv/bin/python -B research/software-stack/attributes_cost_probe.py --output artifacts/jax-stack/attributes-cost-replay
```
