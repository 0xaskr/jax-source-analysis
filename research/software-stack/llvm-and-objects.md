...
[逐 pass 导读](../call-to-llo/matmul-pass-walkthrough.md)。后续 [CPU executable/trace](cpu-executable-and-trace.md)
...
```bash
.venv/bin/python -B research/software-stack/audit_codegen_artifacts.py \
