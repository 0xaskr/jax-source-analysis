...
结果见 [xspace-context-results.json](../tools/xspace-context-results.json)，交互复查见
...
前四份原始 trace 来自 [CPU thunk 实验](../runtime/cpu-executable-and-trace.md)。每个样本执行三次，
...
新增 [host_context_probe.py](../tools/host_context_probe.py) 使用四个 `A[16,16] @ W[16,24]`，
...
[CPU proto/schema 工具](../runtime/cpu-executable-and-trace.md)。生产器要求未设置 `XLA_FLAGS`，
...
run_context_check artifacts/jax-stack/host-context-runtime-new \
  research/software-stack/tools/host_context_probe.py \
...
run_context_check artifacts/jax-stack/xspace-context-audit-new \
  research/software-stack/tools/audit_xspace_contexts.py \
...
run_context_check artifacts/jax-stack/xspace-context-audit-new \
  research/software-stack/tools/verify_xspace_contexts.py \
