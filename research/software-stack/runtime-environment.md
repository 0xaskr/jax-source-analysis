...
```bash
.venv/bin/python -B research/software-stack/prepare_pass_runtime.py \
...
```bash
.venv/bin/python -B research/software-stack/verify_runtime_environment.py --selftest
```
...
artifacts/jax-stack/source-runtime-002/baseline-env/venv/bin/python -B \
  research/software-stack/matmul_probe.py \
  --output artifacts/jax-stack/cpu-matmul-source-new \
  --jaxlib-build-manifest manifests/build-fingerprints/kickoff-cpu-source-003.json
artifacts/jax-stack/source-runtime-002/baseline-env/venv/bin/python -B \
  research/software-stack/verify_research.py --capture artifacts/jax-stack/cpu-matmul-source-new
```
