...
Usage:
  .venv/bin/python -B research/software-stack/render_source_index.py \
    --output research/software-stack/source-index-digest.md
"""
...
INDEX = ROOT / 'research/software-stack/source-index.json'
...
def main():
    ...
    parser.add_argument('--output', type=Path, default=ROOT / 'research/software-stack/source-index-digest.md')
