...
def build_gate(path, expected, observation=None):
    ...
    if expected == "present":
        ...
        approved = [ROOT / "research/software-stack/xla-hlo-pass-events.patch",
                    ROOT / "research/software-stack/xla-hlo-pass-events-with-tests.patch",
                    ROOT / "research/software-stack/xla-hlo-pass-events-exportable.patch"]
