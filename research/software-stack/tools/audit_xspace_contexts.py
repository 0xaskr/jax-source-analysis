...
def collect(output=None, schema_capture=None, thunks=THUNKS, host=HOST):
    ...
    previous = read_json(ROOT / "research/software-stack/tools/cpu-thunk-results.json")
    ...
    result = {"evidence_level": "REPLAY-OFFLINE", "qualifiers": [], "thunk_runtime": thunk_inventory,
              ...
              "thunk_witness": {"path": "research/software-stack/tools/cpu-thunk-results.json", **fingerprint(ROOT / "research/software-stack/tools/cpu-thunk-results.json")},
