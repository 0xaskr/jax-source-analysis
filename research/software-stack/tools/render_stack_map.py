...
Usage:
  python3 -B research/software-stack/tools/render_stack_map.py --output <path.svg> [--check]
"""
...
def main():
    ...
    parser.add_argument('--output', type=Path,
                        default=Path('research/software-stack/figures/jax-stack-components.svg'))
