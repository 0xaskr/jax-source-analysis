...
def main():
    ...
    write_json(output/"manifest.json",{"capture_id":output.name,"outcome":"pass","evidence_level":"SOURCE-ONLY",
        ...
        "producer":{"argv":[".venv/bin/python","-B","research/software-stack/tools/audit_build_dependencies.py","--output",str(output.relative_to(ROOT)),"--build-id",args.build_id],"source":str((output/"producer.py").relative_to(ROOT)),**fingerprint(output/"producer.py")},
